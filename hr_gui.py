...
class HRGUI:
    def __init__(self, root, mitarbeiter_id, vorname):
        ...
        self.window.title("HR Dashboard")
    ...
    def mitarbeiter_suchen(self):
        ...
        def search_and_display():
            ...
            self.tree.column("#0", width=0, stretch=tk.NO) # versteckt die erste Spalte
    ...
    def export_to_xlsx(self, tree):
        ...
        data = []
        columns = ["Eintrag ID", "Typ", "Startzeit", "Endzeit", "Pause (hh:mm)", "Arbeitsstunden (hh:mm)", "Überstunden (hh:mm)", "Entschuldigt", "Bestätigt", "Kommentar"]
        for item in tree.get_children():
